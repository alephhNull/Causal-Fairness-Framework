...
from model import MLPClassifier, train_nn, predict_nn
...
def main():
    ...
    effect_before = estimate_causal_effect(processed_data, causal_graph, "sex_Male", "income")
    ...
    model_nn, scaler = train_nn(X_train, y_train, feature_cols)
    ...
    compute_fairness_metrics(df_results, df_results["income_repaired"], title="AFTER REPAIR")
    ...
    effect_after = estimate_causal_effect(processed_data_repaired, causal_graph, "sex_Male", "income")
